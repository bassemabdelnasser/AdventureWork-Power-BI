...
Open the Power BI file located in the PowerBI folder to explore the interactive dashboard.
Refer to the Documentation folder for detailed insights and explanations.
